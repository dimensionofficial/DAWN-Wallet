...
{
	public class _ProofOfOwnership : UnityEngine.MonoBehaviour
	{
		void Start()
		{
            SignAsCraigWright();
			...
			UnityEngine.Debug.Log(GetFirstBitcoinAddressEver()); // 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa
		}
		...
		static void SignAsCraigWright()
		{
			...
			UnityEngine.Debug.Log(signature); // IN5v9+3HGW1q71OqQ1boSZTm0/DCiMpI8E4JB1nD67TCbIVMRk/e3KrTT9GvOuu3NGN0w8R2lWOV2cxnBp+Of8c=
		}
		static void VerifySatoshi()
		{
			...
			UnityEngine.Debug.Log("Is Craig Wright Satoshi? " + isCraigWrightSatoshi);
		}
		static void VerifyDorier()
		{
			...
			UnityEngine.Debug.Log(address.VerifyMessage(message, signature));
		}
